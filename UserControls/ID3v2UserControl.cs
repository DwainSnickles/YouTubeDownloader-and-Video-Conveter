...
namespace IdSharp.Tagging.Harness.WinForms.UserControls
{
    public partial class ID3v2UserControl : UserControl
    {
        ...
        public void ClearTextboxes()
        {
            ...
            txtPodcastFeedUrl.Clear();
            txtPlayLength.Clear();
            txtBitrate.Clear();
            txtEncoderPreset.Clear();
            chkPodcast.Checked = false;
            cmbGenre.Text = String.Empty;
            cmbImageType.Text = String.Empty;
            if (pictureBox1.Image != null)
            {
                pictureBox1.Image.Dispose();
                pictureBox1.Image = null;
            }
            txtImageDescription.Clear();
        }
        ...
        private void ID3v2UserControl_Load(object sender, EventArgs e)
        {
            cmbID3v2.SelectedIndex = 2;
        }
    }
}
